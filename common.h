...
#define FAIRLOCK_GRANULARITY (CYCLE_PER_MS * 2L)                                    /*this must be changed*/

#define MAX_CHILDREN 5                 /*this is required otherwise you can't work with number of children a node can have*/
#define MAX_LEVEL 3
#define MAX_NODES  126                 /*max_nodes = (max_children**(max_level+1) - 1)/(max_children-1), Gemoetric progression sum*/
